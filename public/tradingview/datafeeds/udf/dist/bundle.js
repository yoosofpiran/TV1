!(function (e, t) {
    "object" == typeof exports && "undefined" != typeof module ? t(exports) : "function" == typeof define && define.amd ? define(["exports"], t) : t(((e = "undefined" != typeof globalThis ? globalThis : e || self).Datafeeds = {}));
})(this, function (e) {
    "use strict";
    var r = function (e, t) {
        return (r =
            ...
            return (
                ...
                new Promise(function (a, u) {
                    s._requester
                        ...
                        .then(function (e) {
                            if ("ok" === e.s || "no_data" === e.s) {
                                ...
                                if ("no_data" === e.s) (r.noData = !0), (r.nextTime = e.nextTime);
                                    ...
                                    for (var s = void 0 !== e.v, o = void 0 !== e.o, n = 0; n < e.t.length; ++n) {
                                        var i = { time: 1e3 * e.t[n], close: parseFloat(e.c[n]), open: parseFloat(e.c[n]), high: parseFloat(e.c[n]), low: parseFloat(e.c[n]) };
                                        o && ((i.open = parseFloat(e.o[n])), (i.high = parseFloat(e.h[n])), (i.low = parseFloat(e.l[n]))), s && (i.volume = parseFloat(e.v[n])), t.push(i);
                                    }
                                a({ bars: t, meta: r });
                            } else u(e.errmsg);
                        })
                        .catch(function (e) {
                            e = n(e);
                            console.warn("HistoryProvider: getBars() failed, error=" + e), u(e);
                        });
                })
            );
        }),
    ...
    var a =
        ((s.prototype.subscribeBars = function (e, t, r, s) {
            this._subscribers.hasOwnProperty(s) || ((this._subscribers[s] = { lastBarTime: null, listener: r, resolution: t, symbolInfo: e }), e.name);
        }),
            ...
            (s.prototype._updateDataForSubscriber = function (t) {
                var r = this,
                    ...
                    o =
                        ...
                        (function (e, t) {
                            var r = 0;
                            r = "D" === e || "1D" === e ? t : "M" === e || "1M" === e ? 31 * t : "M" === e || "2M" === e ? 60 * t :"W" === e || "1W" === e ? 7 * t : (t * parseInt(e)) / 1440;
                            return 24 * r * 60 * 60;
                        })(e.resolution, 10);
                return this._historyProvider.getBars(e.symbolInfo, e.resolution, { from: o, to: s, countBack: 2, firstDataRequest: !1 }).then(function (e) {
                    ...
                    for (t in this._subscribers)
                        !(function (t) {
                            ...
                            o._quotesProvider
                                ...
                                .then(function (e) {
                                    s._requestsPending--, s._subscribers.hasOwnProperty(t) && (r.listener(e), s._requestsPending);
                                })
                                .catch(function (e) {
            ...
            (h.prototype.searchSymbols = function (n, i, a, u) {
                ...
                return this._readyPromise.then(function () {
                    ...
                    var r = s
                        ...
                        .map(function (e) {
                            e = e.symbolInfo;
                            return { symbol: e.name, full_name: e.full_name, description: e.description, exchange: e.exchange, params: [], type: e.type, ticker: e.name };
                        });
                    ...
                    for (var e = r.symbol.length, o = void 0 !== r.ticker; s < e; ++s) {
                        var n = r.symbol[s],
                            ...
                            l = {
                                ...
                                supported_resolutions: _(p(r, "supported-resolutions", s, !0), this._datafeedSupportedResolutions),
                                has_daily: _(p(r, "has-daily", s), !0),
                                intraday_multipliers: _(p(r, "intraday-multipliers", s, !0), ["1", "5", "15", "30", "60"]),
                        ...
                        (this._symbolsInfo[h] = l),
                            ...
                            void 0 !== c && ((this._symbolsInfo[f(h, c)] = l), (this._symbolsInfo[f(n, c)] = l), (this._symbolsInfo[f(u, c)] = l)),
        ...
        ((m.prototype.onReady = function (e) {
                            ...
                            .then(function (e) {
                                if (!Array.isArray(e)) {
                                    for (var t = [], r = 0; r < e.id.length; ++r)
                                        t.push({ id: l(e, "id", r), time: l(e, "time", r), color: l(e, "color", r), text: l(e, "text", r), label: l(e, "label", r), labelFontColor: l(e, "labelFontColor", r), minSize: l(e, "minSize", r) });
                                    e = t;
                                }
                                s(e);
                            })
                ...
                this._configuration.supports_timescale_marks &&
                    ((o = { symbol: e.ticker || "", from: t, to: r, resolution: o }),
                        this._send("timescale_marks", o)
                            .then(function (e) {
                                if (!Array.isArray(e)) {
                                    for (var t = [], r = 0; r < e.id.length; ++r) t.push({ id: l(e, "id", r), time: l(e, "time", r), color: l(e, "color", r), label: l(e, "label", r), tooltip: l(e, "tooltip", r) });
                                    e = t;
                                }
                                s(e);
                            })
            ...
            (m.prototype.searchSymbols = function (e, t, r, s) {
                if (this._configuration.supports_search) {
                    ...
                    this._symbolsStorage.searchSymbols(e, t, r, 30).then(s).catch(s.bind(null, []));
                }
            }),
            ...
            (m.prototype._setupWithConfiguration = function (e) {
                if ((void 0 === (this._configuration = e).exchanges && (e.exchanges = []), !e.supports_search && !e.supports_group_request))
                    throw new Error("Unsupported datafeed configuration. Must either support search, or support group request");
                (!e.supports_group_request && e.supports_search) || (this._symbolsStorage = new c(this._datafeedURL, e.supported_resolutions || [], this._requester)), JSON.stringify(e);
            }),
            m);
    function m(e, t, r, s) {
        var o = this;
        void 0 === s && (s = 1e4),
            ...
            (this._configurationReadyPromise = this._requestConfiguration().then(function (e) {
                null === e && (e = y()), o._setupWithConfiguration(e);
            }));
    }
    function y() {
        return { supports_search: !1, supports_group_request: !0, supported_resolutions: ["1", "5", "15", "30", "60", "1D", "1W", "1M"], supports_marks: !1, supports_timescale_marks: !1 };
    }
    var b =
    ...
    var q,
        w,
        S,
        k = (r((w = I), (S = q = d)), (w.prototype = null === S ? Object.create(S) : ((x.prototype = S.prototype), new x())), I);
    function x() {
        this.constructor = w;
    }
    function I(e, t) {
    ...
    (e.UDFCompatibleDatafeed = k), Object.defineProperty(e, "__esModule", { value: !0 });
});
